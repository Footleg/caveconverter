...
public class DxfToTopoRobotTest {
	...
	public void testDxfToTopoRobotMares3d() throws ParseException, FileNotFoundException {
		...
		String fileCompare = RunFileConverter.convertDxfToTopoRobot( "2649_Mares_from3d", CmdlineSplaysOpt.Default, CmdlineOpt.F, 
				RunFileConverter.defaultCharset );
		assertEquals("Comparing 2649_Mares_from3d TopoRobot file from DXF with reference.", DiffFiles.FILES_IDENTICAL, fileCompare);
	}
	...
	public void testDxfToTopoRobotMaresFromAven() throws ParseException, FileNotFoundException {
		...
		String fileCompare = RunFileConverter.convertDxfToTopoRobot( "2649_Mares_fromaven", CmdlineSplaysOpt.Default, CmdlineOpt.F, 
				RunFileConverter.defaultCharset );
		assertEquals("Comparing 2649_Mares_fromaven TopoRobot file from DXF with reference.", DiffFiles.FILES_IDENTICAL, fileCompare);		
	}
}
