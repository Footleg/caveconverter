...
public class DxfToSurvexTest {
	...
	public void testDxfToSurvexMares3d() throws ParseException, FileNotFoundException {
		...
		String fileCompare = RunFileConverter.convertDxfToSurvex("2649_Mares_from3d", CmdlineSplaysOpt.Default,
				CmdlineOpt.F,
				RunFileConverter.defaultCharset);
		assertEquals(DiffFiles.FILES_IDENTICAL, fileCompare,
				"Comparing 2649_Mares_from3d survex file from DXF with reference.");
	}
	...
	public void testDxfToSurvexMaresFromAven() throws ParseException, FileNotFoundException {
		...
		String fileCompare = RunFileConverter.convertDxfToSurvex("2649_Mares_fromaven", CmdlineSplaysOpt.Default,
				CmdlineOpt.F,
				RunFileConverter.defaultCharset);
		assertEquals(DiffFiles.FILES_IDENTICAL, fileCompare,
				"Comparing 2649_Mares_fromaven survex file from DXF with reference.");
	}
